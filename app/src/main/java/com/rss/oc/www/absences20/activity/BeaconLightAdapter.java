...
public class BeaconLightAdapter extends ArrayAdapter<Beacon> implements Filterable {
    private static final int DARK_GREEN = Color.argb(255, 0, 150, 0);
    private static final int DARK_RED = Color.argb(255, 150, 0, 0);
    private static final String TAG = "BeaconLightAdapter";

    private List<Beacon> beaconList;

    public BeaconLightAdapter(Context context, int resource, List<Beacon> beaconList) {
