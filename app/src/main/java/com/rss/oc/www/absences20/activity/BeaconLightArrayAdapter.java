...
public class BeaconLightArrayAdapter extends ArrayAdapter<Beacon> implements Filterable {
    private static final int DARK_GREEN = Color.argb(255, 0, 150, 0);
    private static final int DARK_RED = Color.argb(255, 150, 0, 0);
    private static final String TAG = "BeaconLightArrayAdapter";

    private List<Beacon> beaconList;

    public BeaconLightArrayAdapter(Context context, int resource, List<Beacon> beaconList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext())
                    .inflate(R.layout.fragment_on_off, parent, false);
        }
